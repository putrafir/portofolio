...
export default function About() {
  ...
  return (
    <section className="relative z-10 px-6 flex  md:px-24 pt-52 pb-20">
      <div className="flex flex-col md:flex-row items-center justify-between md:items-start gap-16">
        ...
        >
          ...
          <motion.p
            variants={itemUp}
            className=" text-xl md:text-3xl  md:mb-4 font-heading"
          >
            ...
            <motion.div variants={iconPop} className="flex gap-4">
              {socials.map((social, i) => (
                <a
                  ...
                  href={social.url}
                  className="
                  group w-8 h-8 md:w-10 md:h-10 rounded-full border border-lavender
